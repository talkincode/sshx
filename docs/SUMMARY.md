...
- [SSHX Documentation](index.md)
  ...
  - [Plans, Outcomes, and Safe Retries](execution-contract.md)
...
- [中文文档](zh/index.md)
  ...
  - [MCP 服务器（stdio）](zh/mcp.md)
  - [审计查询与导出](zh/audit.md)
  - [契约冻结策略](zh/contract.md)
  - [计划、结果与安全重试](zh/execution-contract.md)
